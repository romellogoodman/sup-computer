...
daydream-chess-nanogpt-1. Every path resolves relative to THIS folder:
reads ./games.txt (written by fetch_filtered.py) and writes
./regular/{train,val}.bin + meta.pkl, matching config.py's
out_dir='.', data_root='.', dataset='regular'.
...
OUT_DIR = os.path.join(HERE, "regular")
