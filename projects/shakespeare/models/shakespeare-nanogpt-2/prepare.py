...
Identical corpus and identical held-out test slice as research-lab/data/shakespeare_full, but
...
# identical cleaning + slicing as research-lab/data/shakespeare_full/prepare.py; downloads the
# corpus into this folder so the model is fully self-contained.
...
print("wrote {train,val}.bin in this folder (no meta.pkl -> GPT-2 BPE)")
