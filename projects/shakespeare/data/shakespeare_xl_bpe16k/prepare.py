"""
r5 XL round — enlarged early-modern-drama corpus, custom byte-level BPE (~16384).

Run with the tokenizers lib provided ad hoc (not in pyproject):
    uv run --with tokenizers python projects/shakespeare/data/shakespeare_xl_bpe16k/prepare.py
...
if __name__ == "__main__":
    ...
    build_bpe_dataset("shakespeare_xl_bpe16k", VOCAB_SIZE, train_text, val_text)
