...
# -----------------------------------------------------------------------------
init_from = 'resume' # 'resume' (from an out_dir) is the only mode: the modern core has no GPT-2 init
...
if init_from == 'resume':
    ...
    raise ValueError(f"unknown init_from: {init_from!r} (expected 'resume')")
