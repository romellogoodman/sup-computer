...
Output: raw.txt next to this script (committed, frozen). Deterministic via a
fixed seed, so the corpus regenerates byte-for-byte. (In this frozen release the
corpus is also already vendored as raw.txt; running this overwrites it identically.)
"""
import itertools
import os
import random
