...
Three levers worked; the fourth backfired. The bars step down through Round 3,
then tick back up at Round 4.
...
intelligence each unit of improvement cost. Round 1 (fixing the data
bottleneck) paid off hugely; later rounds returned far less for similar effort,
and Round 4 spent the most and went backwards.
