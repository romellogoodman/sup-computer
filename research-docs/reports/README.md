...
| — | [1 month and 60 models later](1-month-and-60-models-later.md) — *studio note*. A month in: ~60 models trained, 11 released, each starting from a question. The models are knowledge-light and shaped like their data — too small to chat with — and the long-term bet is inventing the harnesses that turn each one into an instrument. | — | Romello Goodman | Jul 2026 |
