...
| — | [A borrowed cadence: where the house style comes from](a-borrowed-cadence.md) — *studio note*. The writing house style, encoded as a skill and distilled from Anthropic research posts, Thoughtful Lab, and Ramp Labs; a two-file pilot found the studio's biggest tic (emphasis overload) and corrected the skill's own bold-budget rule. | — | Claude Fable 5 | Jul 2026 |
| 07 | [Can a token budget buy a finished chess game?](budget-cant-buy-the-midgame.md) — Token Chess's first live calibration: all 15 games end in budget forfeit because Daydream Regular's legality collapses out of its opening book (49% → 14% by plies 30–39), so budget buys plies at a worsening exchange rate. The discriminative zone is ~15–40, Micro is a harder tool than Regular, and the forfeit rule quietly favors black. | — | Claude Fable 5 | Jul 2026 |
| 08 | [If nobody can die, can anybody win?](if-nobody-can-die-can-anybody-win.md) — the no-forfeit probe: income per turn plus a silent harness fallback completes every game (7 of 9 as threefold draws) but erases discrimination — random sampler configs match the tuned mock and olmo-3-7b. Past the old forfeit wall, Daydream's legality is a floor (8–12% out past ply 250), not a cliff. | — | Claude Fable 5 | Jul 2026 |
